...
<script>
function loadGame() {
  document.getElementById('game-container').innerHTML = '<div style="margin: 0 auto; width: 800px;"><iframe src="games/coinpunk/index.html" width="800" height="600" scrolling="no" style="border: 2px solid rgba(255,255,255,0.3); border-radius: 6px;"></iframe></div>';
}
</script>
